...
public interface ResourceRepository extends JpaRepository<Resource, Long> {
	...
	// eu.vrtime.vrm.domain.shared.ResourceCountingResult(r.sessionManager as
	// sessionManager, count(r) as cnt) from Resource r where r.status ='FREE' group
	// by r.sessionManager order by count(*) desc")
