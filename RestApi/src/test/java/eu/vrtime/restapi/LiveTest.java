...
@SpringBootTest(classes = { RestApiApplication.class }, webEnvironment = WebEnvironment.DEFINED_PORT)
...
public class LiveTest {
	...
	private Book createRandomBook() {
		Book book = new Book(RandomStringUtils.randomAlphanumeric(10), RandomStringUtils.randomAlphanumeric(15));
		return book;
	...
	@Test
	public void whenGetAllBooks() {
		Response response = RestAssured.get(API_ROOT + "/getAll");
