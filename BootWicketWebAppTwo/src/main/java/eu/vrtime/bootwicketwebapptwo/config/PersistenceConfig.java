...
@Configuration
@EnableJpaRepositories(basePackages = { "eu.vrtime.bootwicketwebapptwo.repositories" })
@EnableJpaAuditing
@EnableTransactionManagement
public class PersistenceConfig {
	private static final String[] ENTITY_PACKAGES = { "eu.vrtime.bootwicketwebapptwo.model" };
