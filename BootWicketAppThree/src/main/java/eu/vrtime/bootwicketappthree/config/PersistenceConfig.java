...
@Configuration
@EnableJpaRepositories(basePackages = { "eu.vrtime.bootwicketappthree.repositories" })
@EnableJpaAuditing
@EnableTransactionManagement
public class PersistenceConfig {
	private static final String[] ENTITY_PACKAGES = { "eu.vrtime.bootwicketappthree.model" };
