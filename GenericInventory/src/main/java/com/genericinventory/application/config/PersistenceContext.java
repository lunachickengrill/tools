...
@Configuration
@EnableJpaRepositories(basePackages = { "com.genericinventory.infrastructure.persistence" })
@EnableTransactionManagement
@EnableSpringDataWebSupport
public class PersistenceContext {
	private static final String[] ENTITY_PACKAGES = { "com.genericinventory.domain.dataobject",
			"com.genericinventory.domain.objecttype" };
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env) {
		...
		// TEST javax.persistence props

//		jpaProperties.put(PROPERTY_NAME_JPA_SCRIPTS_ACTION, env.getRequiredProperty(PROPERTY_NAME_JPA_SCRIPTS_ACTION));
//		jpaProperties.put(PROPERTY_NAME_JPA_SCRIPTS_CREATE_TARGET,
//				env.getRequiredProperty(PROPERTY_NAME_JPA_SCRIPTS_CREATE_TARGET));
//		jpaProperties.put(PROPERTY_NAME_JPA_SCRIPTS_DROP_TARGET,
//				env.getRequiredProperty(PROPERTY_NAME_JPA_SCRIPTS_DROP_TARGET));
