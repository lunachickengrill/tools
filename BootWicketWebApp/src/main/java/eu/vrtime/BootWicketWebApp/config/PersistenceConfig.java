package eu.vrtime.BootWicketWebApp.config;
...
@Configuration
@EnableJpaRepositories(basePackages= {"eu.vrtime.BootWicketWebApp.repositories"})
@EnableJpaAuditing
@EnableTransactionManagement
public class PersistenceConfig {
	private static final String[] ENTITY_PACKAGES = { "eu.vrtime.BootWicketWebApp.model" };
